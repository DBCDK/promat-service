...
public abstract class ContainerTest extends IntegrationTestIT {
    ...
    protected static final PromatServiceConnector promatServiceConnector  = PromatServiceConnectorFactory.create(PROMATSERVICE_BASE_URL + "/v1/api");
    ...
    public <T> Response putResponse(String path, T body, Map<String, Object> queryParameter, String authToken) {
        HttpPut httpPut = new HttpPut(httpClient).withBaseUrl(PROMATSERVICE_BASE_URL).withPathElements(path);
        if (body != null) {
